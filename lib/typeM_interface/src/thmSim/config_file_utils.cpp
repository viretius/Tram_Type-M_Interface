...
void serial_config_menu()
{
    ...
    USBSerial.print(F("1 -> Kanalnummer eines Ein-/ Ausgangs ändern. Dafür müssen I2C-Address und Pin bekannt sein.\n")); 
    if(VERBOSE){
    ...
    USBSerial.print(F("6 -> Schnittstelle für die Kommunikation mit einem Simulator konfigurieren.\n\n"));
